...
### My assumption before learning:
- It's a scripting language
- Spaces create silly mistakes
- Only functional programming
- Fails in distributed systems (reason unknown)
...
Where does Python fail silently in distributed systems?